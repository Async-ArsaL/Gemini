          ...
          <div className="p-4 text-zinc-200 text-sm leading-relaxed">
            <ReactMarkdown
              ...
              components={{
                ...
                em: ({ node, ...props }) => <em className="text-zinc-300" {...props} />,
                code({ inline, className, children, ...props }) {
                  ...
                  if (inline || !match) {
                    return (
                      <code className="bg-zinc-800/80 border border-zinc-700 px-1.5 py-0.5 rounded text-[0.9em]" {...props}>
                        {children}
                      </code>
                    );
                  }
                    ...
                    <div className="my-3 rounded-xl border border-zinc-800 overflow-hidden">
                      ...
                      <div className="overflow-x-auto">
                        <SyntaxHighlighter
                          ...
                          PreTag="div"
                          wrapLongLines
                          customStyle={{ margin: 0, background: "transparent", fontSize: "0.9rem", borderRadius: 0 }}
                        >
                          {raw}
                        </SyntaxHighlighter>
                      </div>
